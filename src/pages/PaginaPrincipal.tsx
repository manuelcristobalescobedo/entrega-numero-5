...
return (
 ...
 <section className="SeccionCatalogo">
  ...
  <div>
    ...
    <Link to="/producto">
      <div style={{ backgroundImage: "url(/photos/Imagen2.jpg)" }}></div>
      <div>
        <h3>Título del ítem del catálogo</h3>
        <p>Duración del ítem</p>
        <p>Precio del ítem</p>
    ...
    <Link to="/producto">
      <div style={{ backgroundImage: "url(/photos/Imagen3.jpg)" }}></div>
      <div>
        <h3>Título del ítem del catálogo</h3>
        <p>Duración del ítem</p>
        <p>Precio del ítem</p>
    ...
    <Link to="/producto">
      <div style={{ backgroundImage: "url(/photos/Imagen4.jpg)" }}></div>
      <div>
        <h3>Título del ítem del catálogo</h3>
        <p>Duración del ítem</p>
        <p>Precio del ítem</p>
    ...
    <Link to="/producto">
      <div style={{ backgroundImage: "url(/photos/Imagen5.jpg)" }}></div>
      <div>
        <h3>Título del ítem del catálogo</h3>
        <p>Duración del ítem</p>
        <p>Precio del ítem</p>
    ...
    <Link to="/producto">
      <div style={{ backgroundImage: "url(/photos/Imagen6.jpg)" }}></div>
      <div>
        <h3>Título del ítem del catálogo</h3>
        <p>Duración del ítem</p>
        <p>Precio del ítem</p>
